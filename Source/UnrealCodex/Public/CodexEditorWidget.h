 ...
 */
class UNREALCODEX_API SCodexEditorWidget : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SCodexEditorWidget)
	{}
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs);
	virtual ~SCodexEditorWidget();
...
private:
	...
	/** Input area widget */
	TSharedPtr<SCodexInputArea> InputArea;
