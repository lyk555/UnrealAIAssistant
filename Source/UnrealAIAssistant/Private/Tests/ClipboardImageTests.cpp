...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.GetScreenshotDirectory.ReturnsValidPath",
...
bool FClipboardImage_GetScreenshotDirectory_ReturnsValidPath::RunTest(const FString& Parameters)
{
	...
	TestTrue("Should contain UnrealAIAssistant", Dir.Contains(TEXT("UnrealAIAssistant")));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.Cleanup.DeletesOldFiles",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FClipboardImage_Cleanup_DeletesOldFiles::RunTest(const FString& Parameters)
{
	...
	FString TestDir = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("UnrealAIAssistant"), TEXT("test_screenshots"));
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.Cleanup.IgnoresNonClipboardFiles",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

bool FClipboardImage_Cleanup_IgnoresNonClipboardFiles::RunTest(const FString& Parameters)
{
	FString TestDir = FPaths::Combine(FPaths::ProjectSavedDir(), TEXT("UnrealAIAssistant"), TEXT("test_screenshots2"));
	IFileManager::Get().MakeDirectory(*TestDir, true);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.Cleanup.HandlesNonExistentDirectory",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.Constants.ReasonableValues",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FClipboardImage_Constants_ReasonableValues::RunTest(const FString& Parameters)
{
	TestTrue("MaxScreenshotAgeSeconds should be positive",
		UnrealAIAssistantConstants::ClipboardImage::MaxScreenshotAgeSeconds > 0.0);

	TestTrue("MaxScreenshotAgeSeconds should be at least 60 seconds",
		UnrealAIAssistantConstants::ClipboardImage::MaxScreenshotAgeSeconds >= 60.0);

	TestTrue("ThumbnailSize should be positive",
		UnrealAIAssistantConstants::ClipboardImage::ThumbnailSize > 0.0f);

	TestTrue("ThumbnailSize should be reasonable (16-256px)",
		UnrealAIAssistantConstants::ClipboardImage::ThumbnailSize >= 16.0f &&
		UnrealAIAssistantConstants::ClipboardImage::ThumbnailSize <= 256.0f);

	TestTrue("ScreenshotSubdirectory should not be null",
		UnrealAIAssistantConstants::ClipboardImage::ScreenshotSubdirectory != nullptr);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.DataStructs.RequestConfigHasImagePaths",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.DataStructs.PromptOptionsHasImagePaths",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.DataStructs.ConvenienceConstructorPreservesDefaults",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

bool FClipboardImage_PromptOptions_ConvenienceConstructor::RunTest(const FString& Parameters)
{
	FCodexPromptOptions Options(true, false);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.PathValidation.ScreenshotDirIsUnderSaved",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.ClipboardHasImage.DoesNotCrash",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.StreamJson.ParseResultMessage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

bool FClipboardImage_StreamJson_ParseResultMessage::RunTest(const FString& Parameters)
{
	FAssistantCodeRunner Runner;
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.StreamJson.FallbackToAssistantBlocks",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.StreamJson.HandleEmptyOutput",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.StreamJson.HandleMalformedJson",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.StreamJson.BuildPayloadWithImage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.StreamJson.BuildPayloadRejectsInvalidPath",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.StreamJson.BuildPayloadWithoutImage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.StreamJson.BuildPayloadRejectsTraversal",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.StreamJson.BuildPayloadRejectsOversizedImage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.StreamJson.ParseFailureReturnsErrorMessage",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.MultiImage.BuildPayloadWithMultipleImages",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.MultiImage.BuildPayloadRespectsMaxCount",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
bool FClipboardImage_MultiImage_BuildPayloadRespectsMaxCount::RunTest(const FString& Parameters)
{
	...
	TestEqual("Should have 6 content blocks (1 text + 5 images, capped)",
		BlockCount, 1 + UnrealAIAssistantConstants::ClipboardImage::MaxImagesPerMessage);
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.MultiImage.BuildPayloadSkipsInvalidImages",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.MultiImage.BuildPayloadTotalSizeGuard",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.MultiImage.BuildPayloadMixedValidation",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.MultiImage.ConstantsMaxImagesReasonable",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.MultiImage.RequestConfigArrayOperations",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	...
	"UnrealAIAssistant.ClipboardImage.MultiImage.PromptOptionsArrayCopied",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter
)

bool FClipboardImage_MultiImage_PromptOptionsArrayCopied::RunTest(const FString& Parameters)
{
	FCodexPromptOptions Original;
	...
	// Copy
	FCodexPromptOptions Copy = Original;
