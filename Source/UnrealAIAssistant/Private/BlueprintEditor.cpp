	...
	FString& OutError)
{
	...
	UE_LOG(LogUnrealAIAssistant, Log, TEXT("Added variable '%s' to Blueprint '%s'"),
	...
	FString& OutError)
{
	...
	UE_LOG(LogUnrealAIAssistant, Log, TEXT("Removed variable '%s' from Blueprint '%s'"),
		*VariableName, *Blueprint->GetName());
	return true;
}
	...
	FString& OutError)
{
	...
	// nullptr cast for UE 5.5 template deduction
	...
	UE_LOG(LogUnrealAIAssistant, Log, TEXT("Added function '%s' to Blueprint '%s'"),
	...
	FString& OutError)
{
	...
	UE_LOG(LogUnrealAIAssistant, Log, TEXT("Removed function '%s' from Blueprint '%s'"),
		*FunctionName, *Blueprint->GetName());
	return true;
}
