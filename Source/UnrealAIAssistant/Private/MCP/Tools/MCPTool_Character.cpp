...
TSharedPtr<FJsonObject> FMCPTool_Character::CharacterToJson(ACharacter* Character, bool bIncludeMovement)
{
	...
	// Transform
	Json->SetObjectField(TEXT("location"), UnrealAIAssistantJsonUtils::VectorToJson(Character->GetActorLocation()));
	Json->SetObjectField(TEXT("rotation"), UnrealAIAssistantJsonUtils::RotatorToJson(Character->GetActorRotation()));
...
TSharedPtr<FJsonObject> FMCPTool_Character::MovementComponentToJson(UCharacterMovementComponent* Movement)
{
	...
	Json->SetObjectField(TEXT("velocity"), UnrealAIAssistantJsonUtils::VectorToJson(Movement->Velocity));
...
TSharedPtr<FJsonObject> FMCPTool_Character::ComponentToJson(UActorComponent* Component)
{
	...
	if (USceneComponent* SceneComp = Cast<USceneComponent>(Component))
	{
		...
		Json->SetObjectField(TEXT("relative_location"), UnrealAIAssistantJsonUtils::VectorToJson(SceneComp->GetRelativeLocation()));
		Json->SetObjectField(TEXT("relative_rotation"), UnrealAIAssistantJsonUtils::RotatorToJson(SceneComp->GetRelativeRotation()));
