 ...
 * Provides REST API endpoints for Codex to interact with the Unreal Editor
 */
class FUnrealAIAssistantMCPServer
{
public:
	FUnrealAIAssistantMCPServer();
	~FUnrealAIAssistantMCPServer();

	/** Start the MCP server on the specified port */
	bool Start(uint32 Port = UnrealAIAssistantConstants::MCPServer::DefaultPort);
