...
/**
 * Constants used throughout the UnrealAIAssistant plugin
 * Centralizes magic numbers and configuration values
 */
namespace UnrealAIAssistantConstants
{
	// Process and I/O
	namespace Process
	{
		...
		/** Default timeout in seconds for Codex CLI execution */
	...
	namespace ClipboardImage
	{
		...
		/** Subdirectory under Saved/UnrealAIAssistant/ for clipboard screenshots */
		...
		/** Maximum file size per image in bytes (4.5 MB; Codex API limit is 5 MB) */
