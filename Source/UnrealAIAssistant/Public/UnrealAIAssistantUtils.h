...
/**
 * Shared utility classes and functions for UnrealAIAssistant plugin
 ...
 */
class FUnrealAIAssistantOutputDevice : public FOutputDevice
{
public:
	FString Output;
 ...
 */
namespace UnrealAIAssistantJsonUtils
{
	/**
