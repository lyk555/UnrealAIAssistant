 ...
 */
class UNREALAIASSISTANT_API FAssistantCodeRunner : public IAssistantRunner, public FRunnable
{
public:
	FAssistantCodeRunner();
	virtual ~FAssistantCodeRunner();

	// IAssistantRunner interface
