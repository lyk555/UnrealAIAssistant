...
- **PC_Real** (float/double) â†?Use `*_FloatFloat` or `*_DoubleDouble`
- **PC_Int** â†?Use `*_IntInt`
- **PC_Boolean** â†?Use `*_BoolBool`
...
| `add_comparison_chain` | Create variable â†?comparison â†?result chain |
